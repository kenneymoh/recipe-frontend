...
export default function NavBar() {
    ...
    return (
        <nav className="fixed w-full bg-purple-500 shadow">
            <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
                <div>
                    <div className="flex items-center justify-between py-3 md:py-5 md:block">
                        <a href="javascript:void(0)">
                            <h2 className="text-2xl font-bold text-white">RECIPE</h2>
                        </a>
                ...
                <div className='md:flex md:space-x-4 md:inline-block'>
                    ...
                    <div className='px-4 py-1 text-gray-800 bg-white rounded-md shadow hover:bg-gray-100'>
                        <router-link to="/register" class="text-grey hover:bg-gray-700 px-3 rounded py-1">Register</router-link>
                    </div>
                </div>
            </div>
        </nav>
